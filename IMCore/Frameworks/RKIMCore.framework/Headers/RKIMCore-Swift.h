...
- (void)loginWithUserId:(NSString * _Nonnull)userId companyId:(NSString * _Nonnull)companyId;
...
/// 获取群组用户列表
- (void)groupMemberListWithGroupID:(NSString * _Nonnull)groupID compelet:(void (^ _Nonnull)(BOOL, NSString * _Nullable, NSArray<NSString *> * _Nullable))compelet;
/// 创建群组
- (void)createGroupWithGroupName:(NSString * _Nonnull)name groupAvatar:(NSString * _Nonnull)groupAvatar ownerId:(NSString * _Nullable)ownerId ownerJoinFlag:(BOOL)ownerJoinFlag groupConfig:(NSString * _Nullable)groupConfig userList:(NSArray<NSString *> * _Nonnull)users compelet:(void (^ _Nonnull)(BOOL, NSString * _Nullable, id _Nullable))compelet;
/// 拉人入群
...
/// 修改群信息
- (void)updateGroupInfoWithGroupId:(NSString * _Nonnull)groupId groupAvatar:(NSString * _Nullable)groupAvatar ownerId:(NSString * _Nullable)ownerId groupName:(NSString * _Nullable)groupName groupConfig:(NSString * _Nullable)groupConfig compelet:(void (^ _Nonnull)(BOOL, NSString * _Nullable, id _Nullable))compelet;
/// 创建单聊群组
...
/// 创建基类信息
- (void)buildBasicMessageWithReciever:(NSString * _Nullable)reciever receiveGroup:(NSString * _Nullable)receiveGroup compelet:(void (^ _Nonnull)(RKIMMessage * _Nullable, RKMessageDetail * _Nullable))compelet;
/// 发送消息
...
/// secret
- (nonnull instancetype)initWithSocketURL:(NSString * _Nonnull)socketURL httpURL:(NSString * _Nonnull)httpURL appId:(NSString * _Nonnull)appId secret:(NSString * _Nonnull)secret OBJC_DESIGNATED_INITIALIZER;
