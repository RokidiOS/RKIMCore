...
#ifndef RKSOCKET_SWIFT_H
#define RKSOCKET_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RKSocket",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC8RKSocket8RKSocket")
@interface RKSocket : NSObject
...
@interface RKSocket (SWIFT_EXTENSION(RKSocket)) <SRWebSocketDelegate>
/// 初始化失败
...
- (BOOL)webSocketShouldConvertTextFrameToString:(SRWebSocket * _Nonnull)webSocket SWIFT_WARN_UNUSED_RESULT;
/// 收到ping data
